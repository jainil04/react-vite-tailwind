...
const SideNav = () => {
  ...
  return (
    <div>
      ...
      {
        nav ? (
          <div className="fixed w-full h-screen bg-white/90 flex flex-col justify-center place-items-center z-20">
            ...
            <a onClick={handleNav} href="#work" className="w-[75%] flex justify-center item-center rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-200">
              <GrProjects size={20}/>
            ...
            <a onClick={handleNav} href="#contact" className="w-[75%] flex justify-center item-center rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-200">
